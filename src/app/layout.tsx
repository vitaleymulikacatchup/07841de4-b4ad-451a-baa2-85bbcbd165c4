...
export const metadata: Metadata = {
  title: "SuperCoffee - Premium Artisan Coffee Shop",
  description: "Experience exceptional specialty coffee at SuperCoffee. Premium beans, expert roasting, and skilled baristas. Visit us today for your perfect coffee moment.",
  keywords: "coffee shop, specialty coffee, espresso, cappuccino, artisan coffee, premium beans",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "SuperCoffee - Premium Artisan Coffee Shop",
    description: "Experience exceptional specialty coffee crafted with passion",
    siteName: "SuperCoffee",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "SuperCoffee - Premium Artisan Coffee",
    description: "Discover exceptional specialty coffee"
  }
};
